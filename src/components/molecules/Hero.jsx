...
const Hero = () => {
  return (
    ...
    data-aos-duration="1000">
        <p className="text-3xl lg:text-[64px] text-center leading-none text-ctwo font-epilogue font-medium lg:font-bold">Launch your high-paying tech career with <span className="text-cone">real-world experience</span></p>
