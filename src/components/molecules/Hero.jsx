...
const Hero = () => {
  return (
    <div className="p-4 pt-6 pb-8 lg:px-28 lg:py-24 bg-white"  data-aos="zoom-in-up"
    data-aos-duration="1000">
        <p className="text-4xl lg:text-[64px] text-center leading-none text-ctwo font-epilogue font-medium lg:font-bold">Launch your high-paying tech career with <span className="text-cone">real-world experience</span></p>
