  ...
  return (
    ...
    data-aos-anchor-placement="top-center">
      <div className="hidden lg:block w-full">
        ...
        <Link to='https://wa.me/2349128700116' target="_blank"><button className="py-3 mt-4 w-36 lg:w-60 rounded-md lg:rounded text-white bg-cthree font-inter text-sm font-medium ">Join Now</button></Link>
      </div>
      <div className="w-full flex flex-col py-5 items-center lg:hidden">
        ...
        <Link to='https://wa.me/2349128700116' target="_blank"><button className="get-btn py-3 w-52 mt-5">Get Started</button></Link>
      </div>
